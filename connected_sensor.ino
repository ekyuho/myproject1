const char* host = "your_ip";  //"api.thingspeak.com";
String url = "/update?api_key=your_api_key";  
const int httpPort = 5000; //80;
int interval = 1000;

#include <ESP8266WiFi.h>
#include <WiFiClientSecure.h>

const char* ssid = "Seoul IOT_2(2.4G)";
const char* password = "12345678";

String working() { 
  int r = get_co2(); // do some magic here!
...
void setup() {
  Serial.begin(115200);
  connect_ap();
  Serial.println("ESPArduinoThingSpeak.cpp - 2017/11/2");
}
